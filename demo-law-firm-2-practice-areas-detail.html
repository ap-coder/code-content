							...
							<div class="header-row">
									...
									<div class="header-row">
										<ul class="list list-unstyled list-inline mb-0">
											...
											<li class="list-inline-item text-color-dark mr-4 mb-0 d-none d-md-inline-block">
												...
												<a href="mailto:porto@consulting.com" class="text-color-dark text-color-hover-primary text-decoration-none text-2">
													porto@consulting.com
												</a>
											</li>
											<li class="list-inline-item text-color-dark text-2 mb-0 d-none d-lg-inline-block">
												<i class="icons icon-calendar text-color-primary text-3-5 position-relative top-1 mr-1"></i>
												Mon - Fri 9am - 6pm
											</li>
										</ul>
									</div>
								...
								<div class="header-column justify-content-end">
									<div class="header-row">
										...
										<a href="demo-law-firm-2-contact.html" class="btn btn-primary btn-px-4 py-3 font-weight-bold text-2 rounded-0 ml-lg-4">REQUEST CONSULTATION</a>
									</div>
								</div>
							</div>
						</div>
										...
										<div class="header-nav-main header-nav-main-text-capitalize header-nav-main-effect-2 header-nav-main-sub-effect-1">
											<nav class="collapse">
												<ul class="nav nav-pills" id="mainNav">
													...
													<li class="dropdown">
														<a href="demo-law-firm-2-practice-areas.html" class="dropdown-item dropdown-toggle active">Practice Areas</a>
								...
								<div class="card border-0 border-radius-0 custom-box-shadow-1 px-2 mb-5">
									<div class="card-body p-4 my-3">
										...
										<ul class="custom-list-style-1 list list-unstyled font-weight-bold">
											<li>
												<a href="demo-law-firm-2-practice-areas-detail.html" class="text-decoration-none text-color-dark text-color-hover-primary">Family Law</a>
											</li>
											<li>
												<a href="demo-law-firm-2-practice-areas-detail.html" class="text-decoration-none text-color-dark text-color-hover-primary">Capital Law</a>
											</li>
											<li class="active">
												<a href="demo-law-firm-2-practice-areas-detail.html" class="text-decoration-none text-color-primary">Business Law</a>
											</li>
											<li>
												<a href="demo-law-firm-2-practice-areas-detail.html" class="text-decoration-none text-color-dark text-color-hover-primary">Accident & Injury Law</a>
											</li>
											<li>
												<a href="demo-law-firm-2-practice-areas-detail.html" class="text-decoration-none text-color-dark text-color-hover-primary">Health Law</a>
											</li>
										</ul>
									</div>
								</div>
										...
										<form class="contact-form custom-form-style-1 form-errors-light" action="php/contact-form.php" method="POST">
			                                ...
			                                <div class="form-row">
			                                    <div class="form-group col mb-3">
			                                        <input type="text" value="" data-msg-required="Please enter your name." maxlength="100" class="form-control" name="name" id="name" required placeholder="Name *">
			                                    </div>
			                                </div>
			                                <div class="form-row">
			                                    <div class="form-group col mb-3">
			                                        <input type="email" value="" data-msg-required="Please enter your email address." data-msg-email="Please enter a valid email address." maxlength="100" class="form-control" name="email" id="email" required placeholder="E-mail *">
			                                    </div>
			                                </div>
			                                <div class="form-row">
			                                    <div class="form-group col mb-3">
			                                        <input type="text" value="" data-msg-required="Please enter your phone number." maxlength="100" class="form-control" name="phone" id="phone" required placeholder="Phone *">
			                                    </div>
			                                </div>
			                                <div class="form-row">
			                                    <div class="form-group col mb-4">
			                                        <textarea maxlength="5000" data-msg-required="Please enter your message." rows="9" class="form-control" name="message" id="message" required placeholder="Message *"></textarea>
			                                    </div>
			                                </div>
			                                <div class="form-row">
			                                    <div class="form-group col text-lg-right mb-0">
			                                        <button type="submit" class="btn custom-btn-primary-darken font-weight-bold btn-px-5 btn-py-3" data-loading-text="Loading...">REQUEST CONSULTATION</button>
			                                    </div>
			                                </div>
			                            </form>
									</div>
								</div>
								<div class="card bg-primary-darken border-0 border-radius-0 custom-box-shadow-1 py-4">
									<div class="card-body text-center py-5">
										...
										<ul class="list list-unstyled mb-5">
											...
											<li class="mb-3">
												...
												<a href="mailto:porto@consulting.com" class="text-color-light text-decoration-none text-4 text-lg-3 text-xl-4">porto@consulting.com</a>
											</li>
										...
										<a href="demo-law-firm-2-contact.html" data-hash data-hash-offset="100" class="btn btn-primary font-weight-bold text-2 text-lg-1 text-xl-2 btn-px-5 btn-py-3">REQUEST CONSULTATION</a>
									</div>
								</div>
							</aside>
						</div>
